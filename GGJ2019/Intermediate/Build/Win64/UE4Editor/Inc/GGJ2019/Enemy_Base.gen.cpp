...
// Cross Module References
	...
	GGJ2019_API UFunction* Z_Construct_UFunction_AEnemy_Base_DropFoodFood();
	...
	GGJ2019_API UFunction* Z_Construct_UFunction_AEnemy_Base_GetAliveStatus();
	GGJ2019_API UFunction* Z_Construct_UFunction_AEnemy_Base_GetClimbingStatus();
	GGJ2019_API UFunction* Z_Construct_UFunction_AEnemy_Base_GetCrawlingStatus();
	GGJ2019_API UFunction* Z_Construct_UFunction_AEnemy_Base_GetDeathFrame();
	...
	GGJ2019_API UFunction* Z_Construct_UFunction_AEnemy_Base_StartHoldingFood();
...
// End Cross Module References
	static FName NAME_AEnemy_Base_DropFoodFood = FName(TEXT("DropFoodFood"));
	void AEnemy_Base::DropFoodFood(FoodTypes food)
	{
		Enemy_Base_eventDropFoodFood_Parms Parms;
		Parms.food=food;
		ProcessEvent(FindFunctionChecked(NAME_AEnemy_Base_DropFoodFood),&Parms);
	}
	...
	static FName NAME_AEnemy_Base_StartHoldingFood = FName(TEXT("StartHoldingFood"));
	void AEnemy_Base::StartHoldingFood(FoodTypes food)
	{
		Enemy_Base_eventStartHoldingFood_Parms Parms;
		Parms.food=food;
		ProcessEvent(FindFunctionChecked(NAME_AEnemy_Base_StartHoldingFood),&Parms);
	}
	void AEnemy_Base::StaticRegisterNativesAEnemy_Base()
	{
		UClass* Class = AEnemy_Base::StaticClass();
		static const FNameNativePtrPair Funcs[] = {
			{ "GetAliveStatus", &AEnemy_Base::execGetAliveStatus },
			{ "GetClimbingStatus", &AEnemy_Base::execGetClimbingStatus },
			{ "GetCrawlingStatus", &AEnemy_Base::execGetCrawlingStatus },
			{ "GetDeathFrame", &AEnemy_Base::execGetDeathFrame },
	...
	struct Z_Construct_UFunction_AEnemy_Base_DropFoodFood_Statics
	{
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_AEnemy_Base_DropFoodFood_Statics::NewProp_food = { UE4CodeGen_Private::EPropertyClass::Byte, "food", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000080, 1, nullptr, STRUCT_OFFSET(Enemy_Base_eventDropFoodFood_Parms, food), Z_Construct_UEnum_GGJ2019_FoodTypes, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AEnemy_Base_DropFoodFood_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AEnemy_Base_DropFoodFood_Statics::NewProp_food,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AEnemy_Base_DropFoodFood_Statics::Function_MetaDataParams[] = {
		{ "Category", "Food Theft" },
		{ "ModuleRelativePath", "Enemy_Base.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AEnemy_Base_DropFoodFood_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AEnemy_Base, "DropFoodFood", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x0C080800, sizeof(Enemy_Base_eventDropFoodFood_Parms), Z_Construct_UFunction_AEnemy_Base_DropFoodFood_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AEnemy_Base_DropFoodFood_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AEnemy_Base_DropFoodFood_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AEnemy_Base_DropFoodFood_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AEnemy_Base_DropFoodFood()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AEnemy_Base_DropFoodFood_Statics::FuncParams);
		}
	...
	struct Z_Construct_UFunction_AEnemy_Base_GetAliveStatus_Statics
	{
		struct Enemy_Base_eventGetAliveStatus_Parms
		{
			bool ReturnValue;
		};
	...
	void Z_Construct_UFunction_AEnemy_Base_GetAliveStatus_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
		((Enemy_Base_eventGetAliveStatus_Parms*)Obj)->ReturnValue = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_AEnemy_Base_GetAliveStatus_Statics::NewProp_ReturnValue = { UE4CodeGen_Private::EPropertyClass::Bool, "ReturnValue", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000580, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(Enemy_Base_eventGetAliveStatus_Parms), &Z_Construct_UFunction_AEnemy_Base_GetAliveStatus_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AEnemy_Base_GetAliveStatus_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AEnemy_Base_GetAliveStatus_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AEnemy_Base_GetAliveStatus_Statics::Function_MetaDataParams[] = {
		{ "Category", "Animations" },
		{ "ModuleRelativePath", "Enemy_Base.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AEnemy_Base_GetAliveStatus_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AEnemy_Base, "GetAliveStatus", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04080401, sizeof(Enemy_Base_eventGetAliveStatus_Parms), Z_Construct_UFunction_AEnemy_Base_GetAliveStatus_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AEnemy_Base_GetAliveStatus_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AEnemy_Base_GetAliveStatus_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AEnemy_Base_GetAliveStatus_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AEnemy_Base_GetAliveStatus()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AEnemy_Base_GetAliveStatus_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AEnemy_Base_GetClimbingStatus_Statics
	{
		struct Enemy_Base_eventGetClimbingStatus_Parms
		{
			bool ReturnValue;
		};
		static void NewProp_ReturnValue_SetBit(void* Obj);
	...
	void Z_Construct_UFunction_AEnemy_Base_GetClimbingStatus_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
		((Enemy_Base_eventGetClimbingStatus_Parms*)Obj)->ReturnValue = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_AEnemy_Base_GetClimbingStatus_Statics::NewProp_ReturnValue = { UE4CodeGen_Private::EPropertyClass::Bool, "ReturnValue", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000580, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(Enemy_Base_eventGetClimbingStatus_Parms), &Z_Construct_UFunction_AEnemy_Base_GetClimbingStatus_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AEnemy_Base_GetClimbingStatus_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AEnemy_Base_GetClimbingStatus_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AEnemy_Base_GetClimbingStatus_Statics::Function_MetaDataParams[] = {
		{ "Category", "Animations" },
		{ "ModuleRelativePath", "Enemy_Base.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AEnemy_Base_GetClimbingStatus_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AEnemy_Base, "GetClimbingStatus", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04080401, sizeof(Enemy_Base_eventGetClimbingStatus_Parms), Z_Construct_UFunction_AEnemy_Base_GetClimbingStatus_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AEnemy_Base_GetClimbingStatus_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AEnemy_Base_GetClimbingStatus_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AEnemy_Base_GetClimbingStatus_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AEnemy_Base_GetClimbingStatus()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AEnemy_Base_GetClimbingStatus_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AEnemy_Base_GetCrawlingStatus_Statics
	{
		struct Enemy_Base_eventGetCrawlingStatus_Parms
		{
			bool ReturnValue;
		};
		static void NewProp_ReturnValue_SetBit(void* Obj);
	...
	void Z_Construct_UFunction_AEnemy_Base_GetCrawlingStatus_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
		((Enemy_Base_eventGetCrawlingStatus_Parms*)Obj)->ReturnValue = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_AEnemy_Base_GetCrawlingStatus_Statics::NewProp_ReturnValue = { UE4CodeGen_Private::EPropertyClass::Bool, "ReturnValue", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000580, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(Enemy_Base_eventGetCrawlingStatus_Parms), &Z_Construct_UFunction_AEnemy_Base_GetCrawlingStatus_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AEnemy_Base_GetCrawlingStatus_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AEnemy_Base_GetCrawlingStatus_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AEnemy_Base_GetCrawlingStatus_Statics::Function_MetaDataParams[] = {
		{ "Category", "Animations" },
		{ "ModuleRelativePath", "Enemy_Base.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AEnemy_Base_GetCrawlingStatus_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AEnemy_Base, "GetCrawlingStatus", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04080401, sizeof(Enemy_Base_eventGetCrawlingStatus_Parms), Z_Construct_UFunction_AEnemy_Base_GetCrawlingStatus_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AEnemy_Base_GetCrawlingStatus_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AEnemy_Base_GetCrawlingStatus_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AEnemy_Base_GetCrawlingStatus_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AEnemy_Base_GetCrawlingStatus()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AEnemy_Base_GetCrawlingStatus_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AEnemy_Base_GetDeathFrame_Statics
	{
		struct Enemy_Base_eventGetDeathFrame_Parms
		{
			float ReturnValue;
		};
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_AEnemy_Base_GetDeathFrame_Statics::NewProp_ReturnValue = { UE4CodeGen_Private::EPropertyClass::Float, "ReturnValue", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000580, 1, nullptr, STRUCT_OFFSET(Enemy_Base_eventGetDeathFrame_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AEnemy_Base_GetDeathFrame_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AEnemy_Base_GetDeathFrame_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AEnemy_Base_GetDeathFrame_Statics::Function_MetaDataParams[] = {
		{ "Category", "Animations" },
		{ "ModuleRelativePath", "Enemy_Base.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AEnemy_Base_GetDeathFrame_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AEnemy_Base, "GetDeathFrame", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04080401, sizeof(Enemy_Base_eventGetDeathFrame_Parms), Z_Construct_UFunction_AEnemy_Base_GetDeathFrame_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AEnemy_Base_GetDeathFrame_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AEnemy_Base_GetDeathFrame_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AEnemy_Base_GetDeathFrame_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AEnemy_Base_GetDeathFrame()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AEnemy_Base_GetDeathFrame_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_AEnemy_Base_StartHoldingFood_Statics
	{
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_food;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_AEnemy_Base_StartHoldingFood_Statics::NewProp_food = { UE4CodeGen_Private::EPropertyClass::Byte, "food", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000080, 1, nullptr, STRUCT_OFFSET(Enemy_Base_eventStartHoldingFood_Parms, food), Z_Construct_UEnum_GGJ2019_FoodTypes, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AEnemy_Base_StartHoldingFood_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AEnemy_Base_StartHoldingFood_Statics::NewProp_food,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AEnemy_Base_StartHoldingFood_Statics::Function_MetaDataParams[] = {
		{ "Category", "Food Theft" },
		{ "ModuleRelativePath", "Enemy_Base.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AEnemy_Base_StartHoldingFood_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AEnemy_Base, "StartHoldingFood", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x0C080800, sizeof(Enemy_Base_eventStartHoldingFood_Parms), Z_Construct_UFunction_AEnemy_Base_StartHoldingFood_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AEnemy_Base_StartHoldingFood_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AEnemy_Base_StartHoldingFood_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AEnemy_Base_StartHoldingFood_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AEnemy_Base_StartHoldingFood()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AEnemy_Base_StartHoldingFood_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AEnemy_Base_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AEnemy_Base_DropFoodFood, "DropFoodFood" }, // 3550597763
		...
		{ &Z_Construct_UFunction_AEnemy_Base_GetAliveStatus, "GetAliveStatus" }, // 3584422082
		{ &Z_Construct_UFunction_AEnemy_Base_GetClimbingStatus, "GetClimbingStatus" }, // 2075044811
		{ &Z_Construct_UFunction_AEnemy_Base_GetCrawlingStatus, "GetCrawlingStatus" }, // 600995004
		{ &Z_Construct_UFunction_AEnemy_Base_GetDeathFrame, "GetDeathFrame" }, // 2368663838
		...
		{ &Z_Construct_UFunction_AEnemy_Base_StartHoldingFood, "StartHoldingFood" }, // 1029738891
	...
	IMPLEMENT_CLASS(AEnemy_Base, 728779018);
